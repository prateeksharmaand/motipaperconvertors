              ...
              ElevatedButton(
                ...
                onPressed: saving ? null : () async {
                  ...
                  try {
                    ...
                    AppToast.success('Staff member created');
                  } catch (_) { AppToast.error('Failed to create staff'); setModal(() => saving = false); }
                },
            ...
            if (changingPass) ...[
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  ...
                  Navigator.pop(ctx);
                  bloc.add(StaffPasswordChanged(member.id, passCtrl.text));
                },
