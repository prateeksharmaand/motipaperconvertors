              ...
              <tbody>
                {paper?.data?.map((p) => (
                  <tr key={p.id} style={{ borderBottom: "1px solid #f0f0f0", background: p.is_low ? "#fff9f9" : "#fff" }}>
                    ...
                    <td style={td}><button onClick={() => setTxnTarget({ id: p.id, isPaper: true, name: p.name })} style={{ padding: "4px 10px", border: "1px solid #ddd", borderRadius: 6, cursor: "pointer", fontSize: 12, background: "#fff" }}>+ Stock</button></td>
                  </tr>
                ))}
              ...
              <tbody>
                {items?.data?.map((i) => (
                  <tr key={i.id} style={{ borderBottom: "1px solid #f0f0f0", background: i.is_low ? "#fff9f9" : "#fff" }}>
                    ...
                    <td style={td}><button onClick={() => setTxnTarget({ id: i.id, isPaper: false, name: i.name })} style={{ padding: "4px 10px", border: "1px solid #ddd", borderRadius: 6, cursor: "pointer", fontSize: 12, background: "#fff" }}>+ Stock</button></td>
                  </tr>
                ))}
              </tbody>
            </table>
